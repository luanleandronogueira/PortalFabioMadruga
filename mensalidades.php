						...
						<div class="col-12">
							<div class="card">
                                ...
                                <div class="d-grid gap-2">
                                    <a class="btn btn-danger" href="mensalidadesAtrasadas.php" type="button">Ver Mensalidades Atrasadas</a>
                                    <a class="btn btn-warning" href="mensalidadesAbertas.php" type="button">Ver Mensalidades Abertas</a>
                                    <a class="btn btn-success" href="mensalidadesPagas.php" type="button">Ver Mensalidades Pagas</a>
                                    <a class="btn btn-info" href="mensalidadeAnosRetroativos.php"><em>Mensalidades de Anos retroativos</em></a>
                                </div> 									
								</div>
							</div>
						</div>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						...
						<div class="col-4 text-end">
							<p class="mb-0">
								&copy; <?php echo date('Y')?> - <a href="dashboard-default.html" class="text-muted">Fábio Madruga Concursos</a>
							</p>
						</div>
					</div>
				</div>
