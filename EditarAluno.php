					...
					<div class="row">
						<div class="col-12">
							<div class="card">
                                ...
                                <form action="controladores/atualizaDadosAluno.php" method="post">
								    <div class="card-body">
                                        <div class="container">
                                            <div class="row">

                                                <div class="col-xl-3 col-sm-12 col-lg-3 col-md-3 mb-2">
                                                        <label for=""><strong>ID:<b class="text-danger">*</b></strong></label>
                                                        <input class="form-control" readonly required type="text" name="id_aluno" id="cpf" value="<?=$aluno['id_aluno']?>">
                                                </div> 

                                                <div class="col-xl-8 mb-2">
                                                        <label for=""><strong>Nome Completo:<b class="text-danger">*</b></strong></label>
                                                        <input class="form-control" required type="text" name="nome_aluno" value="<?=$aluno['nome_aluno']?>" id=''>
                                                    </div>

													<div class="col-xl-4 mb-2">
                                                        <label for=""><strong>Contato:<b class="text-danger">*</b></strong></label>
                                                        <input class="form-control" required type="text" name="contato_aluno" value="<?=$aluno['contato_aluno']?>" id="telefone">
                                                    </div>

                                                    <div class="col-xl-4 col-sm-12 col-lg-3 col-md-3 mb-2">
                                                        <label for=""><strong>CPF:<b class="text-danger">*</b></strong></label>
                                                        <input class="form-control" required type="text" value="<?=$aluno['cpf_aluno']?>" maxlength="15" name="cpf_aluno" id="cpf">
                                                    </div>

                                                    <div class="col-xl-4 col-sm-12 col-lg-3 col-md-3 mb-2">
                                                        <label for=""><strong>Data de Nascimento:<b class="text-danger">*</b></strong></label>
                                                        <input class="form-control" required type="date" value="<?=$aluno['data_nascimento_aluno']?>" name="data_nascimento_aluno" id="">
                                                    </div>

                                                    <div class="col-xl-12 col-sm-12 col-lg-6 col-md-6 mb-2">
                                                        <label for=""><strong>E-mail:<b class="text-danger">*</b></strong></label>
                                                        <input class="form-control" value="<?=$aluno['email_aluno']?>" type="email" required name="email_aluno" id="">
                                                    </div>

                                                    <div class="col-xl-12 col-sm-12 col-lg-12 col-md-12 mb-2">
                                                        <label for=""><strong>Endereço:<b class="text-danger">*</b></strong></label>
                                                        <textarea class="form-control" name="endereco_aluno" required maxlength="200" id="texto"><?=$aluno['endereco_aluno']?></textarea>
                                                    ...
                                                    <div class="col-xl-3 col-sm-12 col-lg-3 col-md-3 mb-2">
                                                        ...
                                                        <input class="form-control" value="<?=$aluno['senha_portal_aluno']?>" maxlength="20" required type="text" name="senha_portal_aluno" id="">
                                                    ...
                                                    <div class="col-xl-3 col-sm-12 col-lg-3 col-md-3 mb-2">
                                                        ...
                                                        <small><em> Para mudar o status basta clicar</em></small>
                                                    ...
                                                    <button type="submit" class="btn btn-success btn-block">Atualizar Dados do Aluno</button>
