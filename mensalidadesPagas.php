<?php 
	...
	$conn = $conexao->Conectar();
	 ...
	 $query = "SELECT alunos.id_aluno, alunos.nome_aluno, mensalidades.mes, mensalidades.ano, mensalidades.valor, mensalidades.status_pagamento
				...
				WHERE mensalidades.status_pagamento = 'pago' AND mensalidades.ano = YEAR(CURRENT_DATE)";
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
								  <center><h4><span class="badge bg-success">Mensalidades Pagas</span></h4></center>
								  <hr>
									<table id="datatables-buttons" class="table table-striped" style="width:100%">
										...
										<tbody>
											...
											<?php while($ListaAluno = $stmt->fetch(PDO::FETCH_ASSOC)) { 
												...
												if ($ListaAluno['status_pagamento'] == 'pago') {
												?>

												<tr>
													<td><?= $ListaAluno['nome_aluno']?></td>
													<td class="text-success"><em><?= $ListaAluno['status_pagamento']?></em></td>
