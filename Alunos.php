						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Alunos - Fábio Madruga Concursos </h5>

									<!-- Aba para mostrar que foi cadastrado -->
									<?php if(isset($_GET['inclusao']) and $_GET['inclusao'] == 0){ ?>
										
										<center><span class="badge bg-info">Aluno Cadastrado com Sucesso!</span></center>
								...
								<div class="card-body">
								<a class="btn btn-success" href="CadastraNovoAluno.php" type="button">+ Cadastrar novo aluno</a> </br> <br>
									<table id="datatables-buttons" class="table table-striped" style="width:100%">
										...
										<tbody>
											...
											<tr>
												...
												<td><?= $ListaAluno['contato_aluno']?></td>
												<td><?= $ListaAluno['email_aluno']?></td>
												<td><?= $ListaAluno['endereco_aluno']?></td>
												<td><a href="EditarAluno.php?id=<?=$ListaAluno['id_aluno']?>" class="btn btn-sm btn-primary">Editar</a></td>
